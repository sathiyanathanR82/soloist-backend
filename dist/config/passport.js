...
if (process.env.MICROSOFT_CLIENT_ID && process.env.MICROSOFT_CLIENT_SECRET) {
    passport_1.default.use(new passport_microsoft_1.Strategy({
        ...
        callbackURL: (process.env.BACKEND_URL || 'http://localhost:3000') + '/api/auth/microsoft/callback',
...
if (process.env.YAHOO_CLIENT_ID && process.env.YAHOO_CLIENT_SECRET) {
    const yahooStrategy = new passport_oauth2_1.Strategy({
        ...
        callbackURL: (process.env.BACKEND_URL || 'http://localhost:3000') + '/api/auth/yahoo/callback',
